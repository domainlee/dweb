...
(function (factory) {
  ...
  $.extend(true,$.summernote.lang, {
    'en-US': { /* US English(Default Language) */
      imageAttributes: {
        dialogTitle: 'Thuộc tính ảnh',
        tooltip: 'Thuộc tính ảnh',
        tabImage: 'Ảnh',
          src: 'Source',
          browse: 'Browse',
          title: 'Title',
    ...
    'imageAttributes': function (context) {
      ...
      if (options.imageAttributes.disableUpload == false) {
        ...
        body +=    '  <div class="tab-pane note-tab-pane fade in active" id="note-imageAttributes' + timestamp + '">' +
                   ...
                   '      <div class="input-group note-input-group col-xs-12 col-sm-9">' +
                   '        <input class="note-imageAttributes-src form-control note-form-control note-input" disabled="disabled" type="text" />' +
