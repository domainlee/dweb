...
$a = array(
    ...
    'Footer' => array(
        ...
        /**** start *****/
        'startCotGioiThieu1' => array(
            'type' => 'startmodule',
            'label' => 'Cột giới thiệu 1'
        ),
        'Nội dung giới thiệu 1' => array(
            'type' => 'textarea',
        ),
        'endCotGioiThieu1' => array(
            'type' => 'endmodule',
        ),
        /**** end ****/

        /**** start *****/
        'startCotGioiThieu2' => array(
            'type' => 'startmodule',
            'label' => 'Cột giới thiệu 2'
        ),
        'Tiêu đề giới thiệu 2' => array(
            'type' => 'text',
        ),
        'Nội dung giới thiệu 2' => array(
            'type' => 'textarea',
        ),
        'endCotGioiThieu2' => array(
            'type' => 'endmodule',
        ),
        /**** end ****/

        /**** start *****/
        'startDanhMucFooter' => array(
            'type' => 'startmodule',
            'label' => 'Danh mục footer'
        ),
        'Tiêu đề danh mục footer' => array(
            'type' => 'text',
            'description' => 'Lựa chọn danh mục tại phần menu'
        ),
        'endDanhMucFooter' => array(
            'type' => 'endmodule',
        ),
        /**** end ****/

        /**** start *****/
        'startMangXaHoi' => array(
            'type' => 'startmodule',
            'label' => 'Mạng xã hội'
        ),
        'Youtube' => array(
