...
//            ),
        ...
        'Header' => array(
            /**** start *****/
            'startThongTinHeaderTop' => array(
                'type' => 'startmodule',
                'label' => 'Thông tin Header trên cùng'
            ),
            'Hotline' => array(
                'type' => 'text',
            ),
            ...
            'endThongTinHeaderTop' => array(
                'type' => 'endmodule',
            ),
            /**** end *****/

            /**** start *****/
            'startThongTinCotHeader1' => array(
                'type' => 'startmodule',
                'label' => 'Thông tin cột Header 1'
            ),
            'Tiêu đề cột 1' => array(
                'type' => 'text',
            ),
            ...
            'endThongTinCotHeader1' => array(
                'type' => 'endmodule',
            ),
            /**** end *****/

            /**** start *****/
            'startThongTinCotHeade2' => array(
                'type' => 'startmodule',
                'label' => 'Thông tin cột Header 2'
            ),
            'Tiêu đề cột 2' => array(
                'type' => 'text',
            ),
            ...
            'endThongTinCotHeader2' => array(
                'type' => 'endmodule',
            ),
            /**** end *****/

            /**** start *****/
            'startThongTinCotHeader3' => array(
                'type' => 'startmodule',
                'label' => 'Thông tin cột Header 3'
            ),
            'Tiêu đề cột 3' => array(
                'type' => 'text',
            ),
