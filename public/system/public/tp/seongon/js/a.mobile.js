$(function(){
    ...
    // $('.hero-title, .landing-head-hero__content h2, .landing-head-hero__content h1, .landing-head-hero__content p, .landing-head-hero__content a').waypoint(function() {
    //     $('.hero-title, .landing-head-hero__content h2, .landing-head-hero__content h1, .landing-head-hero__content p, .landing-head-hero__content a').addClass('animated fadeInUp');
    // }, {
    //     offset: '75%'
    // });
    //
    ...
    // });
    //
    // $('.our-selection__row, .landing-content__item').waypoint(function() {
